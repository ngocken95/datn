            ...
            <div class="row-fluid">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="<?php echo base_url('admin/account/editaction');?>" name="information_account" id="information_account" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="password" name="re_password" id="re_password" value="<?php echo $item['password'];?>">
                                </div>
                            </div>
                            <div class="control-group">
