                        ...
                        <table class="table table-striped table-responsive table-bordered">
                            ...
                            if(!empty($this->cart->contents())){
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $stt;?></td>
                                        <td><img src="<?php echo base_url('upload/'.$product['option']['img']);?>" alt=""></td>
                                        <td><?php echo $product['name'].' - '.$product['option']['color'];?></td>
                                        <td><?php echo $product['price'];?></td>
                                        <td style="width: 10%"><input type="number" value="<?php echo $product['qty'];?>" name="qty[]" class="form-control"></td>
                                        <td><?php echo $product['subtotal'];?></td>
                                        <td><a href="<?php echo base_url('cart/delete/'.$key);?>"><i class="glyphicon glyphicon-trash"></i></a></td>
                                    </tr>
                                    <?php
                                    $stt++;
                                }
